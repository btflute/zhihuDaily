...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    int index = _mainView.contentOffset.x  / _flowLayout.itemSize.width + 1;
    SDCollectionViewCell * cell = [self.mainView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:index inSection:0]];
    [cell layoutSubviews];
